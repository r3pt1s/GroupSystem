...
class Group {
    ...
    public function isHigher(Group $group): bool {
        $index = array_search($this->getName(), GroupManager::getInstance()->getGroupsConfig()->getAll(true));
        $indexTwo = array_search($group->getName(), GroupManager::getInstance()->getGroupsConfig()->getAll(true));;
